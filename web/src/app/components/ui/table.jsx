  ...
  return (
    <div className="p-2">
      <div className="flex items-center justify-end gap-2 mb-2">
        ...
        <Select id="show-per-page" name="show-per-page" blankMessage="10" options={[{ id: 10, value: 10, id: 20, value: 20 }]} />
      </div>
        ...
        <table className="w-full text-sm text-left text-gray-500 border border-dashed border-gray-200">
          ...
          <tbody>
            {dataSource.map((item, key) => (
              <tr key={key} className="bg-white border-b border-dashed border-gray-200 hover:bg-gray-100 transition-all ease-in-out duration-300">
                {columns.map((i) => (
